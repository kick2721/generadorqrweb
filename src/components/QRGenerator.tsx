...
export default function QRGenerator() {
  ...
  const saveToServer = async (): Promise<string | null> => {
    if (!qrData?.hasValues || !qrData?.content || qrData.content.startsWith("qrwing — ")) return null;
    setSaveError("");
    setSavedOk(false);
    setSaving(true);
    try {
  ...
  const isDownloadable = (() => {
    ...
    if (qrData.type === "url" || qrData.type === "appstore" || qrData.type === "googleplay") {
      try {
