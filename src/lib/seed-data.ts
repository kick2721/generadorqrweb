...
export const SEED_PRODUCTOS: CatalogSeed = {
  categories: [
    {
      ...
      name: "Electronics",
      image: img("categorize-design-v1-1.webp"),
      desc: "Modern gadgets and devices",
      subcategories: [
        {
          id: "audio",
          name: "Audio",
          items: [
            { id: gid(), name: "Wireless Headphones", desc: "Active noise cancellation, 30-hour battery", price: "89.99", image: img("Panna-cotta.webp"), tag: "New" },
            { id: gid(), name: "Bluetooth Speaker", desc: "Portable, waterproof, 360° sound", price: "39.99", image: img("Affogato-al-Caffe.webp") },
            { id: gid(), name: "Studio Microphone", desc: "Cardioid pattern, USB-C, podcast-ready", price: "129.00", image: img("ice-cream-and-berry-fruits-with-chocolate-sauce-an-2024-12-13-05-40-08-utc-1.webp") },
            { id: gid(), name: "Earbuds Pro", desc: "True wireless, transparency mode", price: "59.50", image: img("turkish-dessert-kunefe-served-with-ice-cream-on-wo-2025-02-25-19-14-58-utc.webp"), kcal: "120", time: "8" },
          ],
        },
        {
          id: "wearables",
          name: "Wearables",
          items: [
            { id: gid(), name: "Smartwatch X200", desc: "Heart-rate, GPS, AMOLED display", price: "199.00", image: img("coffee-latte-art-2025-03-25-16-22-03-utc.webp"), tag: "Best Seller" },
            { id: gid(), name: "Fitness Band", desc: "Sleep tracking, 14-day battery", price: "49.99", image: img("matcha-latte-with-latte-art-a-cup-of-japanese-gre-2024-12-02-03-17-00-utc.webp") },
            { id: gid(), name: "VR Headset", desc: "Wireless, 6DoF tracking, 4K per eye", price: "499.00", image: img("Cappuccino-white-coffee-cup-with-heart-shape-art-2024-12-10-01-18-55-utc.webp"), tag: "Premium", kcal: "750", time: "20" },
          ],
        },
      ],
    },
    {
      ...
      name: "Home & Kitchen",
      image: img("categorize-design-v1.webp"),
      desc: "Smart gear for daily life",
      subcategories: [
        {
          id: "kitchen",
          name: "Kitchen",
          items: [
            { id: gid(), name: "Espresso Machine", desc: "15-bar pump, milk frother, dual boiler", price: "349.00", image: img("cup-of-espresso-with-coconut-cookies-on-a-plate-2025-03-12-20-36-13-utc.webp"), tag: "New" },
            { id: gid(), name: "Air Fryer XL", desc: "5.5L capacity, 6 presets", price: "99.00", image: img("rosh-egg-fresh-salad-and-avocado-guacamole-sandw-2025-02-21-00-06-43-utc-1.webp") },
            { id: gid(), name: "Stand Mixer", desc: "5 quart, 10 speeds, tilt-head", price: "279.00", image: img("Tiramisu-1.webp") },
          ],
        },
        {
          id: "lighting",
          name: "Lighting",
          items: [
            { id: gid(), name: "Smart Bulb 4-pack", desc: "16M colors, app + voice control", price: "39.99", image: img("mint-tea-500x500-1.webp") },
            { id: gid(), name: "Desk Lamp Pro", desc: "Adjustable color temp, USB charging", price: "59.00", image: img("special-black-tea.webp") },
            { id: gid(), name: "Mood Strip 5m", desc: "RGBIC, music sync, app control", price: "29.99", image: img("karak-tea.webp"), tag: "Sale" },
          ],
        },
      ],
    },
  ...
  info: {
    ...
    currency: "$",
    language: "en",
    about: "Modern products curated for quality and value.",
  },
  theme: {
    bg: "#f0fdf4",
    cardBg: "#ffffff",
...
export const SEED_SERVICIOS: CatalogSeed = {
  categories: [
    {
      ...
      name: "Consulting",
      image: img("categorize-design-v1-2.webp"),
      desc: "Expert advisory for your business",
      subcategories: [
        {
          id: "strategy",
          name: "Strategy",
          items: [
            { id: gid(), name: "Business Strategy", desc: "Full review of positioning, growth and operations", price: "", image: "" },
            { id: gid(), name: "Marketing Plan", desc: "Channel plan, funnel design, KPIs", price: "", image: "" },
            { id: gid(), name: "Operations Audit", desc: "Process mapping, automation roadmap", price: "", image: "" },
          ],
        },
        {
          id: "design",
          name: "Design",
          items: [
            { id: gid(), name: "Brand Identity", desc: "Logo, palette, typography, brand guidelines", price: "", image: "" },
            { id: gid(), name: "UX Audit", desc: "Heuristic review, usability test, recommendations", price: "", image: "" },
            { id: gid(), name: "Web Design", desc: "Wireframes, hi-fi mockups, design system", price: "", image: "" },
          ],
        },
      ],
    },
    {
      ...
      name: "Technical",
      image: img("categorize-design-v1-3.webp"),
      desc: "Build and integrate with us",
      subcategories: [
        {
          id: "engineering",
          name: "Engineering",
          items: [
            { id: gid(), name: "Web Development", desc: "Modern stacks, SSR/ISR, full-stack delivery", price: "", image: "" },
            { id: gid(), name: "API Integration", desc: "REST, GraphQL, webhooks, partner platforms", price: "", image: "" },
            { id: gid(), name: "Mobile Apps", desc: "iOS, Android, React Native, Flutter", price: "", image: "" },
          ],
        },
        {
          id: "support",
          name: "Support",
          items: [
            { id: gid(), name: "24/7 Incident Support", desc: "Hot-fix SLA, on-call engineers, war-room", price: "", image: "" },
            { id: gid(), name: "Security Audit", desc: "OWASP top-10 review, dependency scan", price: "", image: "" },
            { id: gid(), name: "Performance Tuning", desc: "CWV, caching, query optimization", price: "", image: "" },
          ],
        },
      ],
    },
  ...
  info: {
    ...
    mapsUrl: "",
    language: "en",
    about: "Senior team delivering strategy, design and engineering.",
  },
  theme: {
    bg: "#fafaf9",
    cardBg: "#ffffff",
