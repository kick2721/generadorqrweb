  ...
  categories: [
    {
      id: "electronics",
      name: "Electronics",
      image: U("1498049791950-5f9b8f4b5b5b"),
      ...
      subcategories: [
        {
          ...
          items: [
            { id: gid(), name: "Sony WH-1000XM6", desc: "Industry-leading ANC, 30h battery, LDAC Hi-Res Audio", price: "349.00", image: U("1505740420928-0e8e9d1d9b5b"), tag: "Best Seller" },
            { id: gid(), name: "AirPods Pro 3", desc: "Active Noise Cancellation, Adaptive Audio, USB-C MagSafe", price: "249.00", image: U("1588426428427-7b8f5b5b5b5b") },
            { id: gid(), name: "JBL Flip 7", desc: "Portable BT 5.4 speaker, IP67 waterproof, 20h battery", price: "129.95", image: U("1608043152269-423dbba4e2e1") },
            { id: gid(), name: "Bose QC Ultra Headphones", desc: "World-class noise cancellation, Immersive Audio, 24h", price: "429.00", image: U("1505740420928-0e8e9d1d9b5b"), tag: "Premium" },
            { id: gid(), name: "Samsung Galaxy Buds3 Pro", desc: "2-way speakers, Adaptive ANC, Galaxy AI features", price: "219.99", image: "" },
          ],
        },
        {
          id: "smartwatches",
          name: "Smartwatches",
          items: [
            { id: gid(), name: "Apple Watch Series 11", desc: "ECG, Blood Oxygen, Crash Detection, LTPO3 display", price: "469.00", image: U("1523275335684-37898b6baf30"), tag: "Best Seller" },
            { id: gid(), name: "Samsung Galaxy Watch 8", desc: "Wear OS, BioActive sensor, Antioxidant Index, sleep coach", price: "329.99", image: U("1546868871-af0c3f3bcf84") },
            { id: gid(), name: "Garmin Forerunner 265", desc: "AMOLED display, training metrics, GPS, 13-day battery", price: "449.99", image: "" },
            { id: gid(), name: "Fitbit Charge 6", desc: "Built-in GPS, heart rate, stress management, 7-day battery", price: "159.95", image: U("1523275335684-37898b6baf30") },
            { id: gid(), name: "Google Pixel Watch 3", desc: "Fitbit integration, Pixel AI, Google Assistant", price: "349.99", image: "" },
          ],
        },
        {
          id: "laptops",
          ...
          items: [
            { id: gid(), name: "MacBook Air M4", desc: "Apple M4 chip, 15.3\" Liquid Retina, 18h battery, 16GB RAM", price: "1,299.00", image: U("1496188138207-0e7a0b5e6e7b"), tag: "New" },
            { id: gid(), name: "iPad Pro M4 13\"", desc: "Ultra XDR display, M4 chip, Apple Pencil Pro support", price: "1,299.00", image: "" },
            { id: gid(), name: "Samsung Galaxy Tab S10 Ultra", desc: "14.6\" Dynamic AMOLED, S Pen, 10h battery", price: "1,199.99", image: "" },
            { id: gid(), name: "Dell XPS 16", desc: "Intel Core Ultra 9, 32GB RAM, OLED 4K touch, 16h", price: "2,199.00", image: U("1517336714731-489689fd1ca8") },
            { id: gid(), name: "Asus ROG Ally X", desc: "AMD Ryzen Z1 Extreme, 7\" 120Hz, 24GB RAM, 1TB SSD", price: "799.99", image: "" },
          ],
        },
      ],
    },
    {
      id: "fashion",
      name: "Fashion",
      image: U("1445205547730-8f4b5b5b5b5b"),
      ...
      subcategories: [
        {
          ...
          name: "Men",
          items: [
            { id: gid(), name: "Classic Oxford Shirt", desc: "Premium cotton, slim fit, button-down collar", price: "69.00", image: "" },
            { id: gid(), name: "Slim Fit Chinos", desc: "Stretch cotton twill, tapered leg, 5 pockets", price: "59.00", image: "" },
            { id: gid(), name: "Leather Bomber Jacket", desc: "Genuine lambskin leather, zip front, ribbed cuffs", price: "299.00", image: "", tag: "Premium" },
            { id: gid(), name: "Cashmere Crew Neck Sweater", desc: "100% Mongolian cashmere, 12gg knit, ribbed hem", price: "189.00", image: "" },
            { id: gid(), name: "Sneakers Urban Run", desc: "Breathable mesh, responsive cushioning, gum outsole", price: "89.95", image: U("1491553895911-0055f5c1e0e6") },
          ],
        },
        {
          id: "women",
          name: "Women",
          items: [
            { id: gid(), name: "Linen Blend Dress", desc: "Relaxed fit, V-neck, side pockets, knee length", price: "79.00", image: "" },
            { id: gid(), name: "High-Waist Skinny Jeans", desc: "Stretch denim, 5 pockets, ankle length", price: "69.00", image: "" },
            { id: gid(), name: "Wool Blend Coat", desc: "Double-breasted, notch lapel, mid-calf length", price: "249.00", image: "", tag: "Winter" },
            { id: gid(), name: "Silk Blouse", desc: "100% mulberry silk, hidden button placket", price: "129.00", image: "" },
            { id: gid(), name: "Leather Crossbody Bag", desc: "Full grain leather, adjustable strap, 3 compartments", price: "179.00", image: U("1548036329-9f4b7e2e17a0") },
          ],
        },
        {
          id: "accessories",
          name: "Accessories",
          items: [
            { id: gid(), name: "Aviator Sunglasses", desc: "Polarized UV400 lenses, gold frame, scratch-resistant", price: "149.00", image: U("1572635196237-14b5f281503a") },
            { id: gid(), name: "Minimalist Leather Watch", desc: "Japanese quartz, sapphire crystal, Italian leather strap", price: "199.00", image: "" },
            { id: gid(), name: "Cashmere Scarf", desc: "Pure cashmere, fringed ends, 180x70cm", price: "89.00", image: "" },
            { id: gid(), name: "Canvas Backpack", desc: "Waxed canvas, leather base, laptop sleeve up to 15\"", price: "119.00", image: U("1553062407-98e00164d4e6") },
          ],
        },
      ],
    },
    {
      id: "home-kitchen",
      name: "Home & Kitchen",
      image: U("1556909114-5b5b5b5b5b5b"),
      ...
      subcategories: [
        {
          ...
          name: "Appliances",
          items: [
            { id: gid(), name: "Smart Air Fryer 6L", desc: "Digital touch, 12 presets, Wi-Fi enabled, dishwasher-safe", price: "129.00", image: "", tag: "Best Seller" },
            { id: gid(), name: "Espresso Machine Pro", desc: "15-bar pump, PID temp control, dual boiler, steam wand", price: "549.00", image: "" },
            { id: gid(), name: "Robot Vacuum X3", desc: "LiDAR navigation, 5000Pa suction, self-empty base, 2h runtime", price: "599.99", image: "", tag: "New" },
            { id: gid(), name: "Stand Mixer 5.5qt", desc: "Die-cast metal, 12 speeds, tilt-head, 550W motor", price: "349.00", image: "" },
            { id: gid(), name: "Smart Fridge 28 cu ft", desc: "French door, AI temperature, water/ice dispenser, Wi-Fi", price: "2,499.00", image: "" },
          ],
        },
        {
          id: "lighting",
          name: "Lighting & Decor",
          items: [
            { id: gid(), name: "Smart Bulb 4-Pack", desc: "16M colors, white tunable, voice control, no hub needed", price: "39.99", image: "", tag: "Sale" },
            { id: gid(), name: "LED Desk Lamp", desc: "Adjustable color temp 3000-6500K, wireless charging base", price: "79.00", image: "" },
            { id: gid(), name: "Wi-Fi LED Strip 5m", desc: "RGBIC, music sync, app + voice control, cuttable", price: "29.99", image: "" },
            { id: gid(), name: "Scented Candle Trio", desc: "Soy wax, 200h burn time, vanilla/lavender/sandalwood", price: "34.00", image: "" },
          ],
        },
      ],
    },
      ...
      subcategories: [
        {
          ...
          name: "Fitness",
          items: [
            { id: gid(), name: "Adjustable Dumbbells 52.5lb", desc: "Space-saving, 5-52.5 lb range, quick-change dial", price: "349.00", image: "", tag: "Best Seller" },
            { id: gid(), name: "Yoga Mat Premium 6mm", desc: "Non-slip TPE, alignment lines, carrying strap", price: "49.99", image: "" },
            { id: gid(), name: "Resistance Bands Set", desc: "5 bands 10-50lb, door anchor, ankle straps, carry bag", price: "29.99", image: "" },
            { id: gid(), name: "Jump Rope Speed Pro", desc: "Ball-bearing system, adjustable cable, foam handles", price: "19.95", image: "" },
          ],
        },
        {
          id: "outdoor",
          name: "Outdoor",
          items: [
            { id: gid(), name: "Insulated Water Bottle 1L", desc: "Double-wall vacuum, 24h cold/12h hot, leak-proof", price: "34.95", image: "" },
            { id: gid(), name: "Running Shoes Cloud 6", desc: "Ultralight mesh, Helion foam sole, reflective details", price: "149.99", image: U("1460353581545-07a743c9fc2a") },
            { id: gid(), name: "Hiking Backpack 45L", desc: "Waterproof ripstop, ergonomic frame, rain cover included", price: "129.00", image: "" },
            { id: gid(), name: "Folding Camping Chair", desc: "Padded armrests, cup holder, 330lb capacity, carry bag", price: "59.99", image: "" },
          ],
        },
      ],
    },
  ...
  categories: [
    {
      ...
      image: U("1552664215-5f5b5b5b5b5b"),
      ...
      subcategories: [
        {
          ...
          name: "SEO & Organic",
          items: [
            { id: gid(), name: "SEO Audit & Strategy", desc: "Full technical audit, competitor analysis, keyword roadmap", price: "1,500", image: "", tag: "Popular" },
            { id: gid(), name: "Monthly SEO Retainer", desc: "Ongoing optimization, content strategy, link building, reporting", price: "2,500/mo", image: "", tag: "Best Seller" },
            { id: gid(), name: "Local SEO Package", desc: "Google Business Profile, local citations, review management", price: "800/mo", image: "" },
            { id: gid(), name: "E-commerce SEO", desc: "Product page optimization, structured data, category strategy", price: "3,000/mo", image: "" },
          ],
        },
        {
          id: "paid-ads",
          ...
          items: [
            { id: gid(), name: "Google Ads Setup & Manage", desc: "Search, Shopping, Display campaigns — 20% of ad spend", price: "1,000+/mo", image: "", tag: "Popular" },
            { id: gid(), name: "Social Media Ads", desc: "Meta, TikTok, LinkedIn ads — creative + targeting + optimization", price: "2,000/mo", image: "" },
            { id: gid(), name: "Retargeting Campaign", desc: "Multi-channel retargeting, dynamic ads, conversion tracking", price: "1,200/mo", image: "" },
            { id: gid(), name: "Ad Creative Production", desc: "Video + static ads, A/B testing, platform-optimized formats", price: "500/asset", image: "" },
          ],
        },
        {
          id: "social-media",
          ...
          items: [
            { id: gid(), name: "Starter Social Package", desc: "6 posts/week, 2 platforms, monthly report, community mgmt", price: "1,200/mo", image: "" },
            { id: gid(), name: "Growth Social Package", desc: "Daily posts, 4 platforms, influencer outreach, Stories + Reels", price: "2,800/mo", image: "", tag: "Best Seller" },
            { id: gid(), name: "Content Creation Add-on", desc: "Professional photography, video editing, graphic design", price: "800/mo", image: "" },
            { id: gid(), name: "Influencer Campaign Mgmt", desc: "Sourcing, negotiation, briefing, performance tracking", price: "1,500/mo", image: "" },
          ],
        },
      ],
    },
    {
      ...
      image: U("1561076751-5b5b5b5b5b5b"),
      ...
      subcategories: [
        {
          ...
          name: "Brand Identity",
          items: [
            { id: gid(), name: "Logo Design", desc: "3 concepts, vector files, color variations, brand guidelines", price: "1,500", image: "", tag: "Popular" },
            { id: gid(), name: "Full Brand Identity", desc: "Logo, palette, typography, patterns, templates, full guideline PDF", price: "4,500", image: "", tag: "Best Seller" },
            { id: gid(), name: "Brand Strategy Workshop", desc: "2-day facilitated workshop, positioning, messaging, audience", price: "3,000", image: "" },
            { id: gid(), name: "Visual Identity Refresh", desc: "Update existing brand, new assets, brand book revision", price: "2,500", image: "" },
            { id: gid(), name: "Packaging Design", desc: "3D mockups, die-cut templates, print-ready files, 3 variants", price: "2,800", image: "" },
          ],
        },
        {
          id: "web-uiux",
          ...
          items: [
            { id: gid(), name: "Landing Page Design", desc: "Mobile-first, conversion-optimized, Figma source files", price: "2,000", image: "", tag: "Popular" },
            { id: gid(), name: "Full Website Design", desc: "Up to 10 pages, design system, responsive, Figma + prototypes", price: "6,000", image: "" },
            { id: gid(), name: "UX Audit & Research", desc: "Heuristic eval, usability testing, user interviews, report", price: "3,500", image: "" },
            { id: gid(), name: "Dashboard UI Design", desc: "Complex data visualization, interactive prototypes, dark mode", price: "5,000", image: "" },
            { id: gid(), name: "Design System Setup", desc: "Component library, tokens, docs, Storybook integration", price: "8,000", image: "" },
          ],
        },
      ],
    },
      ...
      subcategories: [
        {
          ...
          items: [
            { id: gid(), name: "Corporate Website", desc: "CMS-based, SEO-optimized, responsive, 5 pages", price: "4,500", image: "", tag: "Popular" },
            { id: gid(), name: "E-commerce Store", desc: "Shopify/Next.js, product mgmt, payments, shipping, 50 products", price: "8,000", image: "" },
            { id: gid(), name: "Custom Web App", desc: "Full-stack React/Node, auth, database, API, 3 months", price: "25,000", image: "" },
            { id: gid(), name: "API Development", desc: "REST/GraphQL, documentation, testing, deployment", price: "6,000", image: "" },
            { id: gid(), name: "Performance Optimization", desc: "CWV audit, lazy loading, caching, CDN setup, 50%+ improvement", price: "2,500", image: "" },
          ],
        },
        {
          id: "mobile",
          name: "Mobile Apps",
          items: [
            { id: gid(), name: "iOS App Development", desc: "Native SwiftUI, App Store submission, 3 months", price: "30,000", image: "" },
            { id: gid(), name: "Android App Development", desc: "Kotlin/Jetpack Compose, Play Store, 3 months", price: "30,000", image: "" },
            { id: gid(), name: "Cross-Platform App (RN)", desc: "React Native, iOS + Android, shared codebase, 2 months", price: "20,000", image: "", tag: "Popular" },
            { id: gid(), name: "App Maintenance", desc: "Bug fixes, OS updates, performance monitoring, monthly", price: "1,500/mo", image: "" },
          ],
        },
        {
          id: "cloud-devops",
          name: "Cloud & DevOps",
          items: [
            { id: gid(), name: "Cloud Migration", desc: "AWS/Azure/GCP assessment, migration plan, execution", price: "12,000", image: "" },
            { id: gid(), name: "CI/CD Pipeline Setup", desc: "GitHub Actions, automated testing, staging/prod deployment", price: "3,500", image: "" },
            { id: gid(), name: "Infrastructure as Code", desc: "Terraform/Pulumi, monitoring, auto-scaling, disaster recovery", price: "6,000", image: "" },
            { id: gid(), name: "Managed DevOps Retainer", desc: "24/7 monitoring, incident response, monthly optimization", price: "2,000/mo", image: "" },
          ],
        },
      ],
    },
      ...
      subcategories: [
        {
          ...
          items: [
            { id: gid(), name: "Business Strategy Session", desc: "4-hour workshop, growth roadmap, KPI framework", price: "2,500", image: "" },
            { id: gid(), name: "Go-to-Market Plan", desc: "Market analysis, channel strategy, launch timeline, budget", price: "5,000", image: "", tag: "Popular" },
            { id: gid(), name: "Operations Audit", desc: "Process mapping, bottlenecks, automation opportunities, report", price: "3,500", image: "" },
            { id: gid(), name: "Fractional COO Service", desc: "Monthly strategic oversight, team management, OKR tracking", price: "4,000/mo", image: "" },
          ],
        },
        {
          id: "analytics",
          name: "Data & Analytics",
          items: [
            { id: gid(), name: "Data Strategy Setup", desc: "Infrastructure, tools, tracking plan, dashboard setup", price: "4,500", image: "" },
            { id: gid(), name: "Analytics Audit", desc: "GA4/Plausible audit, data quality, actionable recommendations", price: "2,000", image: "" },
            { id: gid(), name: "Custom Dashboard Build", desc: "Live KPIs, automated reports, team access, 5 data sources", price: "3,000", image: "" },
            { id: gid(), name: "A/B Testing Program", desc: "Hypothesis creation, experiment design, statistical analysis", price: "2,500/mo", image: "" },
          ],
        },
      ],
    },
