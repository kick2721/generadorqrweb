  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto items-start">
        ...
        <div className="flex flex-col sm:flex-row rounded-2xl border border-purple-500 bg-purple-50 dark:bg-purple-950/30 shadow-lg overflow-hidden">
          ...
          <div className="p-5 flex-1 flex flex-col justify-center bg-white dark:bg-gray-900">
