...
const TYPES = [
  ...
  { icon: <FaWhatsapp color="#25D366" size={24} />, label: "WhatsApp", href: "/qr-whatsapp" },
  ...
  { icon: <FaYoutube color="#FF0000" size={24} />, label: "YouTube", href: "/qr-youtube" },
  { icon: <FaAppStoreIos size={24} />, label: "App Store", href: "/qr-appstore" },
  { icon: <FaTelegramPlane color="#0088cc" size={24} />, label: "Telegram", href: "/qr-telegram" },
...
const USE_CASES = [
  ...
  { icon: <FaInstagram color="#E4405F" size={24} />, label: "Instagram", href: "/qr-para-instagram" },
