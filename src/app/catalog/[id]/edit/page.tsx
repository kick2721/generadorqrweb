                  ...
                  <div className="bg-white rounded-xl border border-neutral-200 shadow-sm p-5 space-y-4">
                    <div className="flex items-center gap-2.5">
                      <div className="w-7 h-7 rounded-lg bg-neutral-100 flex items-center justify-center shrink-0">
                        <svg className="w-3.5 h-3.5 text-neutral-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                      </div>
                      <h3 className="text-xs font-semibold text-neutral-700 uppercase tracking-wider">{t.catalogSetupBusiness}</h3>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex items-center gap-1.5 shrink-0">
                        {info.logo ? (
                          <img src={info.logo} alt="" className="w-10 h-10 rounded-lg object-cover border border-neutral-200" />
                        ) : (
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
                      <div className="flex-1">
                        <label className="text-[10px] text-neutral-400 font-medium mb-1 block">{t.catalogSetupBusiness}</label>
                        <input
                          value={info.name || ""}
                          onChange={(e) => setInfo({ ...info, name: e.target.value })}
                          placeholder={t.catalogSetupBusiness}
                          className="w-full text-sm font-semibold bg-neutral-50 border border-neutral-200 rounded-lg px-3 py-2.5 outline-none focus:border-neutral-400 focus:ring-1 focus:ring-neutral-400/20 transition text-neutral-800 placeholder:text-neutral-400"
                        />
                      </div>
                      <div className="w-full sm:w-28">
                        ...
                        <select
                          ...
                          className="w-full text-xs bg-neutral-50 border border-neutral-200 rounded-lg px-3 py-2.5 outline-none focus:border-neutral-400 focus:ring-1 focus:ring-neutral-400/20 transition text-neutral-700 cursor-pointer"
                        >
                      ...
                      <div className="w-full sm:w-40">
                        ...
                        <input
                          ...
                          className="w-full text-xs bg-neutral-50 border border-neutral-200 rounded-lg px-3 py-2.5 outline-none focus:border-neutral-400 focus:ring-1 focus:ring-neutral-400/20 transition text-neutral-600 placeholder:text-neutral-400"
                        />
                      </div>
                    </div>
                    ...
                    <button
                      onClick={() => setShowBusinessExtra(!showBusinessExtra)}
